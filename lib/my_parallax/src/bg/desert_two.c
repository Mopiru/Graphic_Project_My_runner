...
void add_desert_two2(t_my_parallax *window)
{
	...
	, DESERT_TWO, (sfIntRect){0,0,1920,1080});
	tmp->vitesse.x = -0.2;
...
void add_desert_two(t_my_parallax *window)
{
	...
	, DESERT_TWO, (sfIntRect){0,0,1920,1080});
	tmp->vitesse.x = -0.001;
	tmp = add_to_chain_parallax(window, "./parallax/desert_one/6.png"
	, DESERT_TWO, (sfIntRect){0,0,1920,1080});
	tmp->vitesse.x = -0;
	tmp = add_to_chain_parallax(window, "./parallax/desert_one/5.png"
	, DESERT_TWO, (sfIntRect){0,0,1920,1080});
	tmp->vitesse.x = -0.1;
